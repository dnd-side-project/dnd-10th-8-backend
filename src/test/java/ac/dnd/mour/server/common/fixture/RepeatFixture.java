...
import static ac.dnd.mour.server.schedule.domain.model.Repeat.Type.EVERY_MONTH;
import static ac.dnd.mour.server.schedule.domain.model.Repeat.Type.EVERY_YEAR;
