...
import static ac.dnd.mour.server.acceptance.statistics.StatisticsAcceptanceStep.사용자_트렌드별_평균_행사비_통계를_조회한다_V1;
import static ac.dnd.mour.server.acceptance.statistics.StatisticsAcceptanceStep.자신의_행사별_주고_받은_마음_내역을_조회한다_V1;
...
public class HeartStatisticsAcceptanceTest extends AcceptanceTest {
    ...
    class GetPersonalHeartStatistics {
        ...
        void success() {
            ...
            final ValidatableResponse response1 = 자신의_행사별_주고_받은_마음_내역을_조회한다_V1(2024, 0, member.accessToken()).statusCode(OK.value());
            ...
            final ValidatableResponse response2 = 자신의_행사별_주고_받은_마음_내역을_조회한다_V1(2024, 1, member.accessToken()).statusCode(OK.value());
            assertPersonalHeartStatisticsMatch(
                    response2,
                    List.of(0, 0, 0, 0, 0, 0),
                    List.of(0, 0, 0, 0, 0, 0)
            ...
            final ValidatableResponse response3 = 자신의_행사별_주고_받은_마음_내역을_조회한다_V1(2024, 2, member.accessToken()).statusCode(OK.value());
            assertPersonalHeartStatisticsMatch(
                    response3,
                    List.of(0, 0, 0, 0, 0, 2),
                    List.of(1, 0, 0, 0, 0, 0)
            ...
            final ValidatableResponse response4 = 자신의_행사별_주고_받은_마음_내역을_조회한다_V1(2024, 3, member.accessToken()).statusCode(OK.value());
            assertPersonalHeartStatisticsMatch(
                    response4,
                    List.of(0, 0, 0, 0, 0, 0),
                    List.of(0, 1, 0, 0, 0, 0)
    ...
    class GetTrendHeartAverageStatistics {
        ...
        void success() {
            ...
            final long groupId1 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member1.accessToken());
            final long groupId2 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member2.accessToken());
            final long groupId3 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member3.accessToken());
            final long groupId4 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member4.accessToken());
            final long groupId5 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member5.accessToken());
            final long groupId6 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member6.accessToken());
            final long groupId7 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member7.accessToken());
            final long groupId8 = 관리하고_있는_특정_그룹의_ID를_조회한다_V1("친구", member8.accessToken());
            final long relationId1 = 관계를_생성하고_ID를_추출한다_V1(groupId1, 친구_1.getName(), 친구_1.getImageUrl(), 친구_1.getMemo(), member1.accessToken());
            final long relationId2 = 관계를_생성하고_ID를_추출한다_V1(groupId2, 친구_2.getName(), 친구_2.getImageUrl(), 친구_2.getMemo(), member2.accessToken());
            final long relationId3 = 관계를_생성하고_ID를_추출한다_V1(groupId3, 친구_3.getName(), 친구_3.getImageUrl(), 친구_3.getMemo(), member3.accessToken());
            final long relationId4 = 관계를_생성하고_ID를_추출한다_V1(groupId4, 친구_4.getName(), 친구_4.getImageUrl(), 친구_4.getMemo(), member4.accessToken());
            final long relationId5 = 관계를_생성하고_ID를_추출한다_V1(groupId5, 친구_5.getName(), 친구_5.getImageUrl(), 친구_5.getMemo(), member5.accessToken());
            final long relationId6 = 관계를_생성하고_ID를_추출한다_V1(groupId6, 친구_6.getName(), 친구_6.getImageUrl(), 친구_6.getMemo(), member6.accessToken());
            final long relationId7 = 관계를_생성하고_ID를_추출한다_V1(groupId7, 친구_7.getName(), 친구_7.getImageUrl(), 친구_7.getMemo(), member7.accessToken());
            final long relationId8 = 관계를_생성하고_ID를_추출한다_V1(groupId8, 친구_8.getName(), 친구_8.getImageUrl(), 친구_8.getMemo(), member8.accessToken());
            ...
            final ValidatableResponse response1 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(MALE.getValue(), 20, member1.accessToken()).statusCode(OK.value());
            assertTrendHeartAverageStatisticsMatch(response1, List.of(2_200_000F, 2_150_000F, 0F, 388_000F, 330_000F, 258_000F));

            final ValidatableResponse response2 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(FEMALE.getValue(), 20, member1.accessToken()).statusCode(OK.value());
            assertTrendHeartAverageStatisticsMatch(response2, List.of(0F, 0F, 0F, 0F, 0F, 0F));

            final ValidatableResponse response3 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(MALE.getValue(), 30, member1.accessToken()).statusCode(OK.value());
            assertTrendHeartAverageStatisticsMatch(response3, List.of(560_000F, 23_500_000F, 0F, 1_734_000F, 1_320_000F, 1_558_000F));

            final ValidatableResponse response4 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(FEMALE.getValue(), 30, member1.accessToken()).statusCode(OK.value());
            assertTrendHeartAverageStatisticsMatch(response4, List.of(0F, 0F, 0F, 0F, 0F, 0F));

            final ValidatableResponse response5 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(MALE.getValue(), 40, member1.accessToken()).statusCode(OK.value());
            assertTrendHeartAverageStatisticsMatch(response5, List.of(0F, 0F, 0F, 0F, 0F, 0F));

            final ValidatableResponse response6 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(FEMALE.getValue(), 40, member1.accessToken()).statusCode(OK.value());
            assertTrendHeartAverageStatisticsMatch(response6, List.of(1_593_000F, 980_000F, 0F, 2_123_000F, 5_430_000F, 10_258_000F));

            final ValidatableResponse response7 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(MALE.getValue(), 50, member1.accessToken()).statusCode(OK.value());
            ...
            final ValidatableResponse response8 = 사용자_트렌드별_평균_행사비_통계를_조회한다_V1(FEMALE.getValue(), 50, member1.accessToken()).statusCode(OK.value());
