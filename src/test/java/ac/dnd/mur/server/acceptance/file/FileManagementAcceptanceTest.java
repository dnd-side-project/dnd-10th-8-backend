...
import static ac.dnd.mur.server.acceptance.file.FileAcceptanceStep.이미지_업로드에_대한_Presigned_Url을_응답받는다;
import static ac.dnd.mur.server.common.config.BlackboxLogicControlConfig.BUCKET_UPLOAD_PREFIX;
...
public class FileManagementAcceptanceTest extends AcceptanceTest {
    private static final String BUCKET_URL_PREFIX = "https://mur-upload.s3.amazonaws.com/profiles/";
