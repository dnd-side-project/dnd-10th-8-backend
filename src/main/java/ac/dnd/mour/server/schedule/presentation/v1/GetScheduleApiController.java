...
import ac.dnd.mour.server.schedule.presentation.v1.request.GetCalendarSchedulesRequest;
...
public class GetScheduleApiController {
    ...
    @GetMapping("/schedules/me/{scheduleId}")
    ...
    @GetMapping("/schedules/unrecorded")
